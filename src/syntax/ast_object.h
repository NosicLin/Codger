...
int Ast_ToOperAssignOpcode(AstObject* ab,GrModule* m,
						GrOpcode* op,int,long );
...
static inline int AstObject_CanOperAssign(AstObject* ab)
{
	if(ab->a_type->t_to_oper_and_assign_opcode)
	{
		return 1;
	}
	return 0;
