...
const char* GrOpcode_Name(u_int8_t i)
{
	switch(i)
	{
		...
		OP_CODE_MAP_NAME(OP_CALL_WITH_HOST);
		...
		OP_CODE_MAP_NAME(OP_CLASS_BEGIN);
		OP_CODE_MAP_NAME(OP_LOAD_NIL);
		OP_CODE_MAP_NAME(OP_DISCARD);
		OP_CODE_MAP_NAME(OP_EXPR_DISCARD);
		OP_CODE_MAP_NAME(OP_DUP_DATA1);
		OP_CODE_MAP_NAME(OP_DUP_DATA2);
		OP_CODE_MAP_NAME(OP_DUP_DATA3);
		OP_CODE_MAP_NAME(OP_DATA_SWAP0_1);
		OP_CODE_MAP_NAME(OP_DATA_SWAP0_2);
		OP_CODE_MAP_NAME(OP_DATA_SWAP0_3);
		OP_CODE_MAP_NAME(OP_SET_HOST);
		...
		OP_CODE_MAP_NAME(OP_CLASS_INHERIT);
		OP_CODE_MAP_NAME(OP_CLASS_TEMPLATE);
		OP_CODE_MAP_NAME(OP_CLASS_ATTR);
		...
		OP_CODE_MAP_NAME(OP_IMPORT);
		OP_CODE_MAP_NAME(OP_EXPORT);
		...
		OP_CODE_MAP_NAME(OP_IMPORT2);
		OP_CODE_MAP_NAME(OP_EXPORT2);
		OP_CODE_MAP_NAME(OP_GET_ATTR2);
		OP_CODE_MAP_NAME(OP_SET_ATTR2);
		OP_CODE_MAP_NAME(OP_CLASS_INHERIT2);
		OP_CODE_MAP_NAME(OP_CLASS_TEMPLATE2);
		OP_CODE_MAP_NAME(OP_CLASS_ATTR2);
	}
