...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlfigureA{textbf385}%
\begin{textbf}+, -, \verb|~|, not\end{textbf}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmldisplayA{displaymath1272}%
\begin{displaymath}\frac{AreaSize}{PageSize}-1\end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
